var pokemonRepository = (function() {
  ...
  function a(e) {
    ...
    e.name.charAt(0).toUpperCase(), e.name.slice(1), (a.innerText = e.name);
    var r = document.createElement("img");
    (r.src = e.imageUrl), r.classList.add("modal-img");
    var c = document.createElement("p");
    c.innerText = "Height: " + e.height;
  ...
  return (
    ...
    (t = document.querySelector("#modal-container")).addEventListener(
      "click",
      e => {
        e.target === t && i();
      }
